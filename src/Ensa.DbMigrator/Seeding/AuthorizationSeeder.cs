    ...
    : IDataSeeder
{
    ...
    /// now governs the menu entry (ADR-041).
    /// <para>
    ...
    /// rather than with the permission tables (ADR-040). Migrating faithfully therefore carries
    ...
    /// administration screen as the rest, and it never ran either (ADR-040) - legacy showed a
